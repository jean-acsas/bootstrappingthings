...
- [Quick-setup for Selenium/WebDriver in Python (Firefox)](#quick-setup-for-selenium-webdriver-in-python-(firefox))
...
## Quick-setup for Selenium/WebDriver in Python (Firefox)
